            ...
            {artists.map((artist, key) => {
              ...
              return (
                <li
                  ...
                  ref={listItemRef}
                  key={key}
                  className={`my-5 flex w-full flex-col items-center justify-center text-center text-white ${
                    !active && 'opacity-40'
                  }`}
                >
                  <p className='truncate text-center text-3xl font-bold md:text-5xl lg:text-6xl'>
